...
{messages_text}
    ...
    def _normalize_decision(self, decision):
        ...
        return {
            ...
            "links": self._normalize_links(decision, summary),
    ...
    def _normalize_links(self, decision, summary):
        links = self._normalize_list(decision.get("links"), 20)
        if links:
            return links
        return self._normalize_list(re.findall(r"https?://[^\s）)]+", summary), 20)
