...
11. 如果消息讨论的是 AI/agent/模型互动测试、问卷、小游戏、play skill、角色扮演、边界测试、人格/偏好/权力动态测试，即使包含 BDSM、dom/sub、支配/服从、switch、vanilla 等成人向或关系向词汇，也要按“AI 交互实验/玩法线索”评估；只要有明确 AI 对象、测试方法、结果反馈、可玩的提示词或链接之一，就不要因为词汇敏感或语气玩笑而自动判为普通闲聊。
</decision_policy>
...
- 纯成人向闲聊，且没有 AI/agent/模型互动、工具、测试、问卷、玩法、链接或结果反馈。
