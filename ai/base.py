...
最后，如果有需要特别关注的事项（如@所有人的通知、待办、约定等），加一段：
...
3. 忽略纯表情包、拍一拍、无意义的水消息
4. 用自然流畅的中文书写，不要用列表罗列每条消息
5. 话题标题要具体生动，不要太笼统
6. 如果消息中有 [图片]、[视频]、[链接] 等非文字内容，简要提及即可
7. 不需要加"该总结由AI生成"等声明
